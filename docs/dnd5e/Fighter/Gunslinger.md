...
See the [[dnd5e/Firearms\|firearms]] page for available firearms, and how they function.
...
***Trick Shots.*** You learn two trick shots of your choice, which are detailed one the [[dnd5e/Fighter/Gunslinger/Trickshots\|trickshots page]]. Many maneuvers enhance an attack in some way. Each use of a trick shot must be declared before the attack roll is made. You can use only one trick shot per attack.
